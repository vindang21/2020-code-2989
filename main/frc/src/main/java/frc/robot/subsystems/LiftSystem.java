...
public class LiftSystem extends Subsystem {
  ...
  {
    motor = new StarTalonSRX(RobotMap.CLIMB_MOTOR_PORT);
  }
  ...
  private void applySpeedControllerPreferences() {
    motor.setMaxOutputFunction(() -> RobotMap.CLIMB_MOTOR_SPEED);
  }

  /**
     * move motor to activate climber
     */
    public void climb()
    {
        motor.feed(); 
        motor.set(RobotMap.CLIMB_MOTOR_SPEED);
        //try{Thread.sleep(99);}
        //catch(Exception e){}
        motor.feed(); 
        //motor.set(0);
